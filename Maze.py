...
class Maze:
    ...
    def __init__(self, width: int, height: int, agent_label: str = "@", enable_colors: bool = True, end_symbol: str = f"{Fore.RED}E{Style.RESET_ALL}", start_symbol: str = "S") -> None:
        ...
        self.colors: str = [Fore.BLUE, Fore.CYAN, Fore.GREEN, Fore.LIGHTBLUE_EX, Fore.LIGHTCYAN_EX, Fore.LIGHTGREEN_EX, Fore.LIGHTMAGENTA_EX, Fore.LIGHTRED_EX, Fore.LIGHTYELLOW_EX, Fore.MAGENTA, Fore.RED, Fore.YELLOW]
    ...
    def move(self, new_coords: tuple) -> None:
        self.agent.coords: tuple = new_coords
